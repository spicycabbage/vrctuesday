          ...
          <div key={match.id} className="bg-white rounded-lg shadow p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 p-2 bg-blue-50 rounded">
                ...
                <div className={`w-16 text-center font-bold text-lg rounded ${match.set1?.winner === 1 ? 'bg-green-200' : ''}`}>
                  {match.set1?.team1Score ?? '-'}
                </div>
                <div className={`w-16 text-center font-bold text-lg rounded ${match.set2?.winner === 1 ? 'bg-green-200' : ''}`}>
              ...
              <div className="flex items-center gap-2 p-2 bg-red-50 rounded">
                ...
                <div className={`w-16 text-center font-bold text-lg rounded ${match.set1?.winner === 2 ? 'bg-green-200' : ''}`}>
                  {match.set1?.team2Score ?? '-'}
                </div>
                <div className={`w-16 text-center font-bold text-lg rounded ${match.set2?.winner === 2 ? 'bg-green-200' : ''}`}>
