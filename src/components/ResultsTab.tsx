...
import { Tournament, setsPerMatch } from '@/lib/gameLogic';
          ...
          <div key={match.id} className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1 text-xs font-bold text-gray-700">
                ...
                <div className="w-12 text-center flex-shrink-0">{scoreLabel}</div>
                {!singleSet && <div className="w-12 text-center flex-shrink-0">Set 2</div>}
              </div>
              ...
              <div className="flex items-center gap-1 p-2 bg-blue-50 rounded">
                ...
                <div
                  className={`w-12 text-center font-bold text-base rounded flex-shrink-0 ${
